...
class BarnesHutSuite extends FunSuite {
  ...
  test("2Fork with 3 empty quadrants and 1 leaf (nw)") {
    val b = new Body(123f, 18f, 26f, 0f, 0f)
    val nw = Leaf(17.5f, 27.5f, 5f, Seq(b))
    val ne = Empty(22.5f, 27.5f, 5f)
    val sw = Empty(17.5f, 32.5f, 5f)
  ...
  test("3Fork with 3 empty quadrants and 1 leaf (nw)") {
    val b = new Body(123f, 0.5f, 0.5f, 0f, 0f)
    val nw = Empty(1f, 1f, 2f)
    val ne = Empty(3f, 1f, 2f)
    val sw = Empty(1f, 3f, 2f)
    val se = Empty(3f, 3f, 2f)
    var quad = Fork(nw, ne, sw, se)
    quad = quad.insert(b)
    val b2 = new Body(123f, 1.5f, 1.5f, 0f, 0f)
    quad = quad.insert(b2)

    assert(quad.centerX == 2f, s"${quad.centerX} should be 20f")
    assert(quad.centerY == 2f, s"${quad.centerY} should be 30f")
  }
  ...
  test("1'SectorMatrix.+=' should add a body at (25,47) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 13, 1, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1
    boundaries.minY = 1
    boundaries.maxX = 97
  ...
  test("2'SectorMatrix.+=' should add a body at (25,47) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 13, 1, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1
    boundaries.minY = 1
  ...
  test("3'SectorMatrix.+=' should add a body at (25,47) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 13 + 50, 1 + 50, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1 + 50
    boundaries.minY = 1 + 50
    boundaries.maxX = 97 + 50
    boundaries.maxY = 97 + 50
    val sm = new SectorMatrix(boundaries, SECTOR_PRECISION)
    sm += body
    val res = sm(1, 0).size == 1 && sm(1, 0).find(_ == body).isDefined
    assert(res, s"Body not found in the right sector")
  ...
  test("n'SectorMatrix.+=' should add a body at (25,47) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 25 - 50, 47 - 50, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1 - 50
    boundaries.minY = 1 - 50
    boundaries.maxX = 97 - 50
  ...
  test("4'SectorMatrix.+=' should add a body at (25,47) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 25 - 50, 47 - 50, 0.1f, 0.1f)
    val body2 = new Body(5, 25 - 50, 47 - 50, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1 - 50
    boundaries.minY = 1 - 50
    boundaries.maxX = 97 - 50
