...
$c_Lcalculator_Calculator$.prototype.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D = (function(expr, fromRef, namedExpressions) {
  _calcVal: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Ref(x1)) {
      var x2 = $as_Lcalculator_Ref(x1);
      var name = x2.name$2;
      if (fromRef.contains__O__Z(name)) {
        return (NaN)
      } else {
        var temp$expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(namedExpressions.apply__O__O(name)).apply__O());
        var temp$fromRef = $as_sci_Set(fromRef.$$plus__O__sc_Set(name));
        expr = temp$expr;
        fromRef = temp$fromRef;
        continue _calcVal
      }
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(a, fromRef, namedExpressions) + this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(b, fromRef, namedExpressions))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(a$2, fromRef, namedExpressions) - this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(b$2, fromRef, namedExpressions))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(a$3, fromRef, namedExpressions) * this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(b$3, fromRef, namedExpressions))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(a$4, fromRef, namedExpressions) / this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(b$4, fromRef, namedExpressions))
    } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.calcVal__Lcalculator_Expr__sci_Set__sci_Map__D(expr, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())), references)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(keyValue) {
  var jsx$1 = keyValue.$$und1$f;
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, keyValue$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(keyValue$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, keyValue));
  return new $c_T2().init___O__O(jsx$1, new $c_Lcalculator_Var().init___F0(expr))
});
